  ...
  return (
    <div className="settings-page">
      ...
      <div className="about-storied">
        ...
        <small>
          v0.9.0 · GPL-3.0-or-later · No Storied accounts or analytics · Optional API connections
        </small>
        <p>
          <a
          ...
          {' · '}
          <a href="/storied-source-v0.9.0.zip" download className="text-button small">
            Download source
          </a>
        </p>
      </div>
